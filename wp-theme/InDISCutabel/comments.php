...
<?php if ( have_comments() ) : ?>
	<h4 id="comments"><?php comments_number(__('No Responses', 'kubrick'), __('One Response', 'kubrick'), __('% Responses', 'kubrick'));?> <?php printf(__('to &#8220;%s&#8221;', 'kubrick'), the_title('', '', false)); ?></h4>
 ...
 <?php else : // this is displayed if there are no comments so far ?>
	...
	<?php if ( comments_open() ) : ?>
	 ...
	 <?php else : // comments are closed ?><!-- comments are closed. -->
		<?php if ( !is_page() ) : ?> <!-- only show comments closed for non-pages -->
